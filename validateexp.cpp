...
QString validateExp::validate(QString exp)
{
    ...
    QString e1Result = validateElectrode(e1Mode,splitExp[1],splitExp[2],splitExp[3],splitExp[4]);
    QString e2Result = validateElectrode(e2Mode,splitExp[6],splitExp[7],splitExp[8],splitExp[9]);
...
QString validateExp::validateElectrode(int mode, QString d1, QString d2, QString d3, QString d4)
{
    switch (mode){
    case 1:
    {
